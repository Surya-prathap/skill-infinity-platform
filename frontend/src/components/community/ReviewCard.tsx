...
import { REVIEW_DIMENSION_LABELS } from '@/features/community/constants';
import { useReportMutation, useReviewVoteMutation } from '@/features/community';
            ...
            <Stack direction="row" alignItems="center" gap={1} sx={{ mt: 1.5, pt: 1.25, borderTop: 1, borderColor: 'divider' }}>
              ...
              <Tooltip title="Report review">
                <IconButton
                  size="small"
                  onClick={() =>
                    reportMutation.mutate({ targetType: 'REVIEW', targetId: review.id, reason: 'Inappropriate content' })
                  }
