...
import { RatingDistribution, ReviewCard, StarRating, ReviewComposerModal } from '@/components/community';
...
import { useMentorRatingSummaryQuery, useMentorReviewsQuery } from '@/features/community';
              ...
              <Box>
                ...
                <Stack direction="row" alignItems="center" gap={0.5}>
                  ...
                  <Typography variant="caption" color="text.secondary">
                    {Math.round((stats.totalReviews * 0.92))}% verified sessions
                  </Typography>
                </Stack>
                <Typography variant="caption" color="text.secondary">
