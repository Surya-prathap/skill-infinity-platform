...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Razorpay subscription first-charge verification payload")
public class RazorpaySubscriptionVerifyRequest {

    @NotBlank(message = "Payment ID is required")
    @Schema(description = "Internal payment ID returned by /subscription/checkout", requiredMode = Schema.RequiredMode.REQUIRED)
